              ...
              {filteredTrades.length > 0 ? (
                <div className="overflow-x-auto">
                    ...
                    <table className="w-full">
                      ...
                      <tbody>
                        {filteredTrades.slice(0, 10).map((trade) => (
                          <tr key={trade.id} className="border-b border-slate-700 hover:bg-slate-750 transition-colors">
                  ...
                  <div className="md:hidden space-y-3">
                    {filteredTrades.slice(0, 10).map((trade) => (
                      <div key={trade.id} className="bg-slate-900/50 rounded-lg p-4 border border-slate-700/50">
